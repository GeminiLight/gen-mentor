// Ported verbatim from backend/modules/personalized_resource_delivery/prompts/search_enhanced_knowledge_drafter.py.
...
export const knowledgeDrafterSystem = `
...
/** task; placeholders: external_resources, knowledge_point, learner_profile, learning_session */
export const knowledgeDrafterTask = `
