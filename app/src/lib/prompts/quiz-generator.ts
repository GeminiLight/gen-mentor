...
export const quizGeneratorSystem = `
...
/** task; placeholders: learner_profile, learning_document, multiple_choice_count, short_answer_count, single_choice_count, true_false_count */
export const quizGeneratorTask = `
