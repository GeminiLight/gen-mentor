...
export const pathSchedulerSystem = `
...
/** task; placeholders: learner_profile, session_count */
export const pathSchedulerCreateTask = `
...
/** task; placeholders: feedback, learning_path */
export const pathSchedulerRefineTask = `
...
/** task; placeholders: learner_profile, learning_path, other_feedback, session_count */
export const pathSchedulerRescheduleTask = `
