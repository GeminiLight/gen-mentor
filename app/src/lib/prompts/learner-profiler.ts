...
- For mastered skills, \`proficiency_level\` must be one of: "beginner", "intermediate", "advanced" (never "unlearned"). For in-progress skills, \`current_proficiency_level\` may also be "unlearned".
...
/** task; placeholders: learner_information, learning_goal, skill_gaps */
export const learnerProfilerInitTask = `
Task A. Initial Profiling. 
...
/** task; placeholders: learner_information, learner_interactions, learner_profile, session_information */
export const learnerProfilerUpdateTask = `
Task B: Profile Update
