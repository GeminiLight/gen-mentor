...
export interface OnboardingCheckpoint {
  ...
  done: { refined_goal?: string; gap?: SkillGaps & SkillRequirements; learner_profile?: LearnerProfile; confirmed?: boolean };
  review?: { deadline: number | null; goal_draft?: string };
}
const empty = { goal: "", info: "", count: "0", checkpoint: null as OnboardingCheckpoint | null };
interface Draft {
